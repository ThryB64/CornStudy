...
SOURCES: list[dict[str, Any]] = [
    ...
    {"source": "Open-Meteo Historical Forecast API", "use": "archive de prévisions 'telle que connue J' (1 lead)",
     "availability": "gratuit", "cost": "0 (rate-limited)", "api": "REST public",
     "constraints": "1 lead seulement (~J-1) ; timeouts fréquents sur longues fenêtres",
     "status": "PARTIAL_BEST_EFFORT", "unblocks": ["V136 archive extrêmes"]},
    {"source": "Open-Meteo Previous-Runs API", "use": "séries à lead fixe 1-7 j -> vraies révisions multi-lead",
     "availability": "gratuit", "cost": "0 (rate-limited)", "api": "REST public",
     "constraints": "depuis 2024 ; itérer par lead ; best-effort timeout",
     "status": "ACTIONABLE", "unblocks": ["VN-C4 forecast revision tape (leading)"]},
    ...
    {"source": "Eurostat COMEXT (bulk)", "use": "flux physiques import/export maïs EU",
     "availability": "public (bulk download)", "cost": "0",
     "api": "bulk CSV mensuel/annuel depuis 1988 (pas la petite API de dissémination)",
     "constraints": "fichiers volumineux ; détrend YoY obligatoire (confond tendance, cf V71)",
     "status": "PARTIAL_BEST_EFFORT", "unblocks": ["VN-C2/C3 tension physique EU (prime locale)"]},
    {"source": "USDA NASS QuickStats / WASDE calendar", "use": "dates exactes des rapports (catalyseurs V129/V137)",
     "availability": "gratuit", "cost": "0", "api": "QuickStats REST (clé gratuite) + calendrier officiel 2026",
     "constraints": "clé API pour QuickStats ; dates de release publiées",
     "status": "ACTIONABLE", "unblocks": ["VN-C5 attribution CBOT_WASDE exacte (V137)"]},
